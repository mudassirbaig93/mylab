...
router.post("/", auth, async (req, res) => {
  ...
  // this is the case of multi document update
  // To gain Atomicity on such operations we need to use two phased commits here
  // so can't do this like below
  //   rental = await rental.save();
  //   movie.numberInStock--;
  //   movie.save();

  // node package to perform two phased commits
  try {
    new Fawn.Task()
      .save("rentals", rental)
